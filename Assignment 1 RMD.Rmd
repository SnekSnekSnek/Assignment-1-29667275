...
words
```{r}
FinalDataframe2 = subset(FinalDataframe, select = -c(3:8))
#Rework this line to factor down for the thing
...
ggplot(data = FinalDataframe3Graphing, aes(x = factor(Year))) +
  ...
  labs(caption = "This simple graph allows an easy visualisation of trends over time. One graph is provided for each country. ",color="Type Of Drink\n") +
  scale_color_manual(labels = c("France", "Italy","Australia","Belgium","Denmark","United Kingdom","Finland","Japan","Netherlands","Norway"),values = c("blue", "red","black","green","orange","powderblue","brown","pink","maroon","purple")) +
